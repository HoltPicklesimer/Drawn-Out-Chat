...
app.get("/getChatRoom", chatController.getChatRoom)
app.get("/getChatUsers", chatController.getChatUsers)
app.get("/getRoomComments", chatController.getRoomComments)
app.post("/postRoom", chatController.postRoom)
app.post("/addUser", chatController.addUser)
app.post("/putImage", chatController.putImage)
app.post("/removeUserFromRoom", chatController.removeUserFromRoom);