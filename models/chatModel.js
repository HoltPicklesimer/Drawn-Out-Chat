...
var queries = [
	...
	"with rows as ( INSERT INTO chat_rooms (name, admin_id, image_data) VALUES ($1::varchar, $2::int, '{''clickX'':[],''clickY'':[],''clickDrag'':[],''clickColor'':[],''clickSize'':[]}') RETURNING id ); \
	INSERT INTO chat_users (user_id, chat_id) VALUES ($2::int, SELECT id FROM rows);",
